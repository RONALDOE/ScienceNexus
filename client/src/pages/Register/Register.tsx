...
export default function Register() {
  ...
  return (
    <div className='w-screen h-screen flex flex-row-reverse bg-slate-300'>
      <div className='login_left_image w-[50%] h-full block'></div>
      <div className='w-[50%] h-full flex justify-center items-center '>
        <div className='bg-slate-200 rounded-xl border-2 border-black w-[40rem] max-h-max py-8 flex flex-col justify-center items-center gap-6 '>
          ...
          <FormControl sx={{ width: '60%' }} variant="outlined">
            <InputLabel htmlFor="outlined-username">Tu Tag</InputLabel>
            <OutlinedInput
              id="outlined-username"
              type="text"
              value={username}
